                            ...
                            <tr class="text-gray-700 dark:text-gray-400">
                                ...
                                <td class="px-4 py-3">
                                    <div class="flex items-center space-x-4 text-sm">
                                        <a href="/management_inv_squads/show/{{$data->id_management_inv_squad }}" title="show" class="badge badge-info">Show</a>
                                        <a href="/management_inv_squads/edit/{{$data->id_management_inv_squad }}" class="badge badge-warning">Edit</a>
