        ...
        <div class="card">
            ...
            Tambah
                ...
                <table class="table table-hover">
                    ...
                    <tr>
                        <th>#</th>
                        <th>id_event_teams</th><th>squad_id</th><th>isfree</th><th>ispaid</th><th>created_at</th><th>updated_at</th>
                        <th>Action</th>
                    </tr>
                    </thead>
                    <tbody>
                  @foreach ($event_teams as $data)
                    <tr class="text-gray-700 dark:text-gray-400">
                        ...
                        <td>{{$data->id_event_teams}}</td><td>{{$data->squad_id}}</td><td>{{$data->isfree}}</td><td>{{$data->ispaid}}</td><td>{{$data->created_at}}</td><td>{{$data->updated_at}}</td>
                        <td class="px-4 py-3">
