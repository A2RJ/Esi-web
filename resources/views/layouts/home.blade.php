...
<head>
    ...
    <link rel="stylesheet" href="/assets/landing-page/vendors/owl-carousel/css/owl.carousel.min.css">
    <link rel="stylesheet" href="/assets/landing-page/vendors/owl-carousel/css/owl.theme.default.css">
    <link rel="stylesheet" href="/assets/landing-page/vendors/mdi/css/materialdesignicons.min.css">
    <link rel="stylesheet" href="/assets/landing-page/vendors/aos/css/aos.css">
    <link rel="stylesheet" href="/assets/landing-page/css/style.min.css">
...
<body id="body" data-spy="scroll" data-target=".navbar" data-offset="100">
        ...
        <nav class="navbar navbar-expand-lg pl-3 pl-sm-0 {{ request()->route()->uri !== 'anggota' ? 'bg-white' : '' }}" id="navbar">
            <div class="container">
                <div class="navbar-brand-wrapper d-flex w-100">
                    <img src="/assets/landing-page/images/1639985799654.jpg" style="width: 80px;" alt="">
    ...
    <section class="container contact-details" style="margin-top: 150px;" id="contact-details-section">
        <div class="row text-center text-md-left">
            <div class="col-12 col-md-6 col-lg-3 grid-margin">
                <img src="/assets/landing-page/images/1639985799654.jpg" style="width: 80px;" alt="" class="pb-2">
                <div class="pt-2">
    ...
    <script src="/assets/landing-page/vendors/jquery/jquery.min.js"></script>
    <script src="/assets/landing-page/vendors/bootstrap/bootstrap.min.js"></script>
    <script src="/assets/landing-page/vendors/owl-carousel/js/owl.carousel.min.js"></script>
    <script src="/assets/landing-page/vendors/aos/js/aos.js"></script>
    <script src="/assets/landing-page/js/landingpage.js"></script>
</body>
