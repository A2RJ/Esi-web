        ...
        <div class="card">
            <div class="card-body">
                ...
                <!-- <p class="card-description">
                    <a class="btn btn-primary" href="/anggota/managements" title="Go back"> Batal </a>
                </p> -->
                ...
                <form action="/anggota/managements/update/{{$management->id_management}}" method="POST" enctype="multipart/form-data">
                    @csrf
                    <!-- @method('PUT') -->
                    <div class="row">
