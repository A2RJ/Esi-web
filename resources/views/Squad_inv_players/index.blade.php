                    ...
                    <table class="table table-hover">
                        ...
                        <tbody>
                            ...
                            <tr class="text-gray-700 dark:text-gray-400">
                                ...
                                <td>{{$data->id_squad_inv_player}}</td>
                                <td>{{$data->squad_id}}</td>
                                ...
                                <td class="px-4 py-3">
                                    <div class="flex items-center space-x-4 text-sm">
                                        <a href="/squad_inv_players/show/{{$data->id_squad_inv_player }}" title="show" class="badge badge-info">Show</a>
                                        <a href="/squad_inv_players/edit/{{$data->id_squad_inv_player }}" class="badge badge-warning">Edit</a>
